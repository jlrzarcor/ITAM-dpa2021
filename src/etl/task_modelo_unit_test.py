...
import src.test.test_modelo as tsm
...
class TaskModelUnitTest(CopyToTable):
    ...
    def requires(self):
        return TaskModel(self.bucket, self.prc_path, self.year, self.month, self.day, self.flg_i0_c1, self.force3_err)
    ...
    def rows(self):
        ...
        marble_obj = tsm.TestModel()
        marble_obj.test_score()
